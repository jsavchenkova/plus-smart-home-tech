...
public class ScenarioAddedAvroSerializer implements Serializer<ScenarioAddedEventAvro> {
    private static final Logger log = LoggerFactory.getLogger(ScenarioAddedAvroSerializer.class);
