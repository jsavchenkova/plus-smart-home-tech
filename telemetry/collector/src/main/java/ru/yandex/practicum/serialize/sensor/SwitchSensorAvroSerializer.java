...
public class SwitchSensorAvroSerializer implements Serializer<SwitchSensorAvro> {
    private static final Logger log = LoggerFactory.getLogger(SwitchSensorAvroSerializer.class);
    private static final HexFormat hexFormat = HexFormat.ofDelimiter(":");

    @Override
    public byte[] serialize(String topic, SwitchSensorAvro event) {
        if (event == null) {
            return null;
        }
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            DatumWriter<SwitchSensorAvro> datumWriter = new SpecificDatumWriter<>(SwitchSensorAvro.class);
