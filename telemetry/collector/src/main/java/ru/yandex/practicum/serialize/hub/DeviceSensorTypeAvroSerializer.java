...
public class DeviceSensorTypeAvroSerializer implements Serializer<DeviceTypeAvro> {
    private static final Logger log = LoggerFactory.getLogger(DeviceSensorTypeAvroSerializer.class);
    private static final HexFormat hexFormat = HexFormat.ofDelimiter(":");

    @Override
    public byte[] serialize(String topic, DeviceTypeAvro event) {
        if (event == null) {
            return null;
        }
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            DatumWriter<DeviceTypeAvro> datumWriter = new SpecificDatumWriter<>(DeviceTypeAvro.class);
